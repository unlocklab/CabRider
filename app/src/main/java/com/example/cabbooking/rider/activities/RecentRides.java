...
public class RecentRides extends AppCompatActivity implements AdpListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rec_rides);
        ...
        try{
            ...
            right_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try{
                        if (Validations.valEdit(RecentRides.this, et1, getString(R.string.feedback))
                                && Const.isOnline(RecentRides.this)) {
    ...
    private void addAdp() {
        ...
        RidesAdp mainAdp = new RidesAdp(this, l1);
    ...
    public void click1(int position) {
        if(l1.get(position).getStatus().equals(Const.completed)){
            ...
            final TripDto tripDto = l1.get(position);
            if (dialog1 != null && dialog1.isShowing()) {
                dialog1.dismiss();
            }
